...
export const DjBooth: React.FC<DjBoothProps> = ({ profile }) => {
  ...
  // Reset secret click counter after delay
  useEffect(() => {
  ...
  const inputStyles =
    "w-full bg-[var(--input-bg)] border border-[var(--input-border)] rounded-lg px-3 py-2 text-[var(--text-primary)] placeholder-[var(--text-secondary)] focus:ring-1 focus:ring-[var(--accent-primary)] focus:border-[var(--accent-primary)] outline-none";
        ...
        <div className="p-3 h-full flex flex-col">
          <div className="flex justify-between items-center mb-3">
            <h3
              ...
              className="font-bold text-md font-display text-yellow-400 cursor-pointer select-none"
              title="Triple-tap for Secret Menu"
            >
              🎛️ VIP DJ Booth
            </h3>
            {isUnlocked && (
          ...
          {isUnlocked ? (
            <div className="animate-fade-in flex-grow flex flex-col">
              ...
              <div className="space-y-2 mb-3">
                ...
                {showRestartButton && (
                  <div className="pt-2 mt-2 border-t border-white/10 w-full animate-fade-in">
                    <button
                      onClick={
                        isUnlocked
                          ? () => {
            ...
            <div className="flex flex-col items-center gap-3 justify-center flex-grow">
              <button
                onClick={toggleInput}
                className="p-3 bg-black/30 rounded-full hover:bg-white/10 transition-colors"
                title="Enter DJ Booth"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {isInputVisible && (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full text-center bg-[var(--accent-secondary)] text-white font-bold py-2 px-4 rounded-lg hover:bg-[var(--accent-primary)] transition-colors duration-300 text-sm"
                  >
                    Enter
                  </button>
                </form>
