...
export const LyricStage: React.FC<LyricStageProps> = ({
  currentLine,
  nextLine,
  previousLine,
  intensity = 0,
            ...
            >
              <span
                ...
                style={{
                  ...
                  animationDelay:
                    meta?.animation === AnimationType.BOUNCE
                      ? `${i * 0.1}s`
                      : "0s",
                }}
              >
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden perspective-1000 p-8 md:p-12">
      ...
      <div
        className={`w-full flex justify-center items-center ${transitionType === "glitch" ? "animate-glitch-snap" : ""}`}
      >
        {/* Main Lyric Display */}
        <div
        ...
        >
          <div
            ...
            style={{
              ...
              filter:
                "saturate(calc(100% + var(--audio-bass, 0) * 100%)) brightness(calc(100% + var(--audio-bass, 0) * 40%))",
            }}
          >
            {renderWords(false)}
          </div>
