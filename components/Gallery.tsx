        ...
        <div className="space-y-8">
            <header className="flex justify-between items-start mb-4">
                <div className="text-left">
                    ...
                    <p className="mt-2 text-[var(--text-secondary)]">A showcase of your generated work.</p>
                </div>
                 <button 
            ...
            {items.length === 0 ? (
                <SectionCard>
                    <div className="p-16 text-center">
                        <h2 className="text-2xl font-bold font-display text-[var(--text-secondary)]">Your gallery is empty.</h2>
                        <p className="mt-2 text-[var(--text-secondary)]">Go back to the studio to start creating album covers and music videos!</p>
                    </div>
                </SectionCard>
            ) : (
