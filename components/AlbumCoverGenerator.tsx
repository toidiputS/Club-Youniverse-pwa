...
export const AlbumCoverGenerator: React.FC<AlbumCoverGeneratorProps> = ({
        ...
        <header className="flex justify-between items-start mb-12">
          <div className="text-left">
            ...
            <p className="mt-2 text-[var(--text-secondary)]">
              Only VIPs can access AI branding tools.
            </p>
          </div>
          <button
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        e.message || "An unexpected error occurred during image generation.",
      );
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="animate-fade-in">
      <header className="flex justify-between items-start mb-12">
        <div className="text-left">
          ...
          <p className="mt-2 text-[var(--text-secondary)]">
            Design beautiful, square album art for your music.
          </p>
        </div>
        <button
          onClick={onBackToStudio}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <SectionCard>
          <div className="p-8">
            <h2 className="text-2xl font-bold mb-6 text-center text-[var(--accent-primary)] font-display">
            ...
            <form onSubmit={handleGenerate} className="space-y-6">
              ...
              <div className="p-3 border border-yellow-400/30 rounded-lg bg-yellow-900/10 text-sm text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Based on one Imagen 4.0 image generation.
                </p>
              </div>
              ...
              >
                {isLoading
                  ? "Generating..."
                  : `Generate Album Cover (~${formatCurrency(estimatedCost.total)})`}
              </button>
            </form>
          </div>
        </SectionCard>
              ...
              {isLoading ? (
                ...
                <div className="w-full aspect-square flex flex-col items-center justify-center bg-black/30 rounded-lg border-2 border-dashed border-gray-600">
                  ...
                  <p className="mt-4 text-gray-400">
                    Your generated album cover will appear here.
                  </p>
                </div>
              )}
            </div>
