    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50">
      <SectionCard className="max-w-lg w-full">
        <div className="p-8 text-center">
          <h2 className="text-3xl font-bold font-display text-yellow-400 mb-4">API Key Required</h2>
          <p className="text-gray-300 mb-6">
            This application uses the Veo video generation model, which requires you to select your own Google AI Studio API key. Your key is used directly and is not stored by this application.
          </p>
          <button
          ...
          <p className="text-xs text-gray-500 mt-4">
            ...
            <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-400">
