...
const StudioCard: React.FC<{
  ...
  <div onClick={onClick} className="cursor-pointer group">
    <SectionCard className={`h-full p-8 flex flex-col items-center justify-center text-center transition-all duration-500 group-hover:border-[var(--accent-primary)] group-hover:scale-105 group-hover:shadow-[0_0_20px_var(--accent-primary)] ${isPrimary ? 'bg-gradient-to-br from-[var(--accent-primary)]/10 to-transparent' : ''}`}>
      {icon}
      <h2 className="text-2xl font-bold font-display text-[var(--accent-secondary)]">{title}</h2>
  ...
  return (
    <div className="flex-grow flex flex-col pb-12">
      <header className="text-center mb-12">
        ...
        <p className="mt-2 text-[var(--text-secondary)]">Welcome to the Studio, {profile?.name || 'Creator'}.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <StudioCard
          ...
          isPrimary
          icon={<svg xmlns="http://www.w3.org/2000/svg" className={iconStyles} viewBox="0 0 20 20" fill="currentColor"><path d="M18 3a1 1 0 00-1.447-.894L8.763 6.19A5.002 5.002 0 005 10c0 .984.286 1.89.763 2.691l-2.47 1.544A3.002 3.002 0 012 13.13V12a1 1 0 00-2 0v1.132a5.002 5.002 0 004.288 4.908l2.47-1.544A5.002 5.002 0 0010 15a5 5 0 004.237-2.19l7.794-4.87a1 1 0 00-.03-1.742zM10 13a3 3 0 110-6 3 3 0 010 6z" /></svg>}
        ...
        <StudioCard
          ...
          icon={<svg xmlns="http://www.w3.org/2000/svg" className={iconStyles} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>}
          title="Submit a Song"
        ...
        <StudioCard
          ...
          icon={<svg xmlns="http://www.w3.org/2000/svg" className={iconStyles} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 000 2h6a1 1 0 100-2H7z" clipRule="evenodd" /></svg>}
          title="The Graveyard"
